...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Admin | E-Services | Barangay Clearance</title>
        ...
        <div class=wrapper>
            ...
            <div class="mainContent">
                ...
                <div class="info">
                    ...
                    <td>
                        <form action = "admin_brgy_clearance.php" method = "post">
                            <div class="container">
                                <div class="search">
                                    <div class="searchBox">
                    ...
                    <td>
                        <form action = "admin_brgy_clearance.php" method = "post">
                            <div class="btn refreshBtn">
                                <button class="fas fa-redo"><a href="admin_brgy_clearance.php"></a></button>
                            </div>
                        </form>
                    </td>
                    </table>
                    ...
                    $query = "SELECT * FROM brgy_clearance";
                    ...
                    if (isset($_POST['edit'])&&$id==$_POST['edit']){ 
                        ...
                        $query=mysqli_query($con,"SELECT * FROM brgy_clearance WHERE id='$id2'");
                        $row=mysqli_fetch_array($query);
                        
                        //echo "<h2 id = editor_lbl>Editor</h2>";
                        echo "<form action='admin_brgy_clearance.php' method='POST'>";
                        ?>
                        <tr>
                            <td>
                            ...
                            <td id = sql_table>
                                <label id = "edit_lbl">BirthDate: </label>
                                <input id = "edit_input" type="date" value="<?php echo $row['Birthdate']; ?>" name="BDAY">
                            </td>
                            <td id = sql_table>
                    ...
                    /*=====EDIT END=====*/
                        ...
                        echo "<td id = sql_table_date>" . $row['Birthdate'] . "</td>";
...
if (isset($_POST['delete'])){ 
    ...
    mysqli_query($con,"DELETE FROM brgy_clearance WHERE id = '$id'");
    header("location: admin_brgy_clearance.php");
    ob_end_flush();
}
...
if (isset($_POST['submitedit'])){
    ...
    mysqli_query($con,"UPDATE brgy_clearance SET 
    FName='$FN', LName='$LN', MInitial='$MI' 
    ,Age='$AGE', Birthdate='$BDAY', CTC='$CTC' 
    ,Issued='$IS'
    WHERE id='$id3'");
    header("location: admin_brgy_clearance.php");
    ob_end_flush();
