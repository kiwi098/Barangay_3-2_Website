...
<br>
    ...
    <div class = "form_content">
        ...
        <label class = "Date_Label">ISSUED DATE</label> <br><br>

        <input class = "CTC_Input" type = "int" name = "CTC"  placeholder= "CTC Number"> 
        <input class = "Date_Input" type = "date" name = "Issued" placeholder= " "> <br><br>

        <label class = "Business_Label">BUSINESS NAME </label> <br>
        <input class = "Business_Input" type = "text" name = "BN" placeholder = "Business Name"> <br><br>
    </div>
...
if(isset($_POST['btnSubmit'])){
    ...
    mysqli_query($con, "INSERT into brgy_business(id, FName, MInitial, LName, CTC, Issued, BName) VALUES (null, '$FName', '$MInitial', '$LName', '$CTC', '$Issued', '$BName')");
