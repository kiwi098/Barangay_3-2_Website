...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Admin | E-Services | Certificate of Residency</title>
        ...
        <div class=wrapper>
            ...
            <div class="mainContent">
                ...
                <div class="info">
                    ...
                    <td>
                        <form action = "admin_certificate_residency.php" method = "post">
                            <div class="container">
                                <div class="search">
                                    <div class="searchBox">
                    ...
                    <td>
                        <form action = "admin_certificate_residency.php" method = "post">
                            <div class="btn refreshBtn">
                                <button class="fas fa-redo"><a href="admin_certificate_residency.php"></a></button>
                            </div>
                        </form>
                    </td>
                    </table>
                    ...
                    $query = "SELECT * FROM brgy_residency";
                    ...
                    if(isset($_POST['Search'])) {
                        ...
                        OR id LIKE '%$searchq%' OR PStreet LIKE '%$searchq%'";
                        $result = mysqli_query($con,$query);
                    }
                    ...
                    <td id = sql_head>AGE</td>
                    <td id = sql_head>CIVILSTATUS</td>
                    <td id = sql_head>PUROK/STREET</td>
                    ...
                    if (isset($_POST['edit'])&&$id==$_POST['edit']){ 
                        ...
                        $query=mysqli_query($con,"SELECT * FROM brgy_residency WHERE id='$id2'");
                        $row=mysqli_fetch_array($query);
                        
                        //echo "<h2 id = editor_lbl>Editor</h2>";
                        echo "<form action='admin_certificate_residency.php' method='POST'>";
                        ?>
                        <tr>
                            <td>
                            ...
                            <td id = sql_table>
                                <label id = "edit_lbl">Age: </label>
                                <input id = "edit_input" type="text" value="<?php echo $row['Age']; ?>" name="AGE">
                            </td>
                            <td id = sql_table>
                                <label id = "edit_lbl">CivilStatus: </label>
                                <select class = "edit_input" name = "CS">
                                    <option value = "<?php echo $row['CStatus']; ?>" selected hidden>Choose</option> 
                            ...
                            <td id = sql_table>
                                <label id = "edit_lbl">Purok/Street: </label>
                                <input id = "edit_input" type="text" value="<?php echo $row['PStreet']; ?>" name="PS">
                            </td>
                            <td id = sql_option>
                    ...
                    /*=====EDIT END=====*/
                        ...
                        echo "<td id = sql_table>" . $row['Age'] . "</td>";
                        echo "<td id = sql_table>" . $row['CStatus'] . "</td>";
                        echo "<td id = sql_table>" . $row['PStreet'] . "</td>";
                        ?>
...
if (isset($_POST['delete'])){ 
    ...
    mysqli_query($con,"DELETE FROM brgy_residency WHERE id = '$id'");
    header("location: admin_certificate_residency.php");
    ob_end_flush();
}
...
if (isset($_POST['submitedit'])){
    ...
    mysqli_query($con,"UPDATE brgy_residency SET 
    FName='$FN', LName='$LN', MInitial='$MI' 
    , Age='$AGE' ,CStatus='$CS' ,PStreet='$PS'
    WHERE id='$id3'");
    header("location: admin_certificate_residency.php");
    ob_end_flush();
}
