...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Admin | E-Services | Administrator Accounts</title>
        ...
        <div class=wrapper>
            ...
            <div class="mainContent">
                ...
                <table class = "top_table">
                    <td>
                        <form action = "admin_admin.php" method = "post">
                            <div class="container">
                                <div class="search">
                                    <div class="searchBox">
                    ...
                    <td>
                        <form action = "admin_admin.php" method = "post">
                            <div class="btn refreshBtn">
                                <button class="fas fa-redo"><a href="admin_admin.php"></a></button>
                            </div>
                        </form>
                    </td>
                    </table>
                    ...
                    if (isset($_POST['edit'])&&$id==$_POST['edit']){ 
                        ...
                        $query=mysqli_query($con,"SELECT * FROM admin WHERE id='$id2'");
                        $row=mysqli_fetch_array($query);
                        
                        //echo "<h2 id = editor_lbl>Editor</h2>";
                        echo "<form action='admin_admin.php' method='POST'>";
                        ?>
                        <tr>
                            <td>
