...
<br>
    ...
    <div class = "form_content">
        ...
        <label class = "BDay_Label" >BIRTHDAY </label>
        <label class = "Age_Label" >AGE </label> <br>

        <input class = "BDay_Input" type = "date" name = "Birthdate"  placeholder= " ">
        <input class = "Age_Input" type = "int" name = "Age"  placeholder= "Age"> <br> <br>

        <label class = "CTC_Label" >COMMUNITY TAX CERTIFICATE </label> 
        <label class = "Date_Label" >ISSUED DATE </label> <br>

        <input class = "CTC_Input" type = "int" name = "CTC"  placeholder= "CTC Number">
        <input class = "Date_Input" type = "date" name = "Issued"  placeholder= " "> 
    </div>
...
if(isset($_POST['btnSubmit'])){
    ...
    mysqli_query($con, "INSERT into brgy_clearance(id, FName, LName, MInitial, Age, Birthdate, CTC, Issued) VALUES (null, '$FName', '$LName', '$MInitial', '$Age', '$Birthdate', '$CTC', '$Issued')");
